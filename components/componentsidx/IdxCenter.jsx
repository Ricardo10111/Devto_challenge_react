...
export default function CenterPost({ reactionCounts }) {
  ...
  return (
    <main className='h-dvh w-full m-0 flex items-center flex-col sm:ml-0 md:p-3  md:mr-[20px]  max-w-[66rem]'>
      <div className='flex flex-col font-roboto bg-white border-2 border-gray-300 rounded-lg pb-5 m-5 relative w-full mb-2.5 gap-4 ax-w-[66rem]'>
        <img
        ...
        <div className='flex justify-start ml-[30px] -mt-5'>
          <h2 className='text-[30px] md:text-[50px] font-bold hover:text-[#3b49df] cursor-pointer'>
            {post.title}
          </h2>
        </div>
